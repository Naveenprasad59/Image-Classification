...
model, criterion, optimizer = nn_setup('vgg16',0.5,120,0.001,'gpu')
trainloader , vloader, testloader=load_data(where= "./flowers")
def train_network(model, criterion, optimizer, epochs = 3, print_every=20, loader=trainloader, power='gpu'):
    ...
    print("Dear User training is completed")
...
def process_image(image_path):
    ...
    img = Image.open('./flowers/test/1/image_06752.jpg') # Here we open the image
